...
public class TestDynamicsOne extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_dynamics_one);
    ...
    public void RightAnswer(View inputView) {
        ...
        if (guess == "forte") {
            ...
            Toast.makeText(getApplicationContext(), "Correct!",
                    Toast.LENGTH_SHORT).show();
            Intent i = new Intent(this, TestDynamicsTwo.class);
            startActivity(i);
        } else {
