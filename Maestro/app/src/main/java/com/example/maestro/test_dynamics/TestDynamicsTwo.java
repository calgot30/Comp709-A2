...
public class TestDynamicsTwo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_dynamics_two);
    ...
    public void RightAnswer(View inputView) {
        ...
        if (guess == "piano") {
            ...
            Toast.makeText(getApplicationContext(), "Correct!",
                    Toast.LENGTH_SHORT).show();
            Intent i = new Intent(this, TestDynamicsThree.class);
            startActivity(i);
        } else {
